...
public class ConstantValue implements Value {
    ...
    ConstantValue(BasicValue type, Object value) {
        ...
        if (type == BasicValue.INT_VALUE && !(value instanceof Integer)) {
            ...
            // All non-decimal numbers smaller than Integer including Character should be held as Integer.
    ...
    public boolean isCertain() {
        return !(this.equals(ConstantTracker.NULL) ||
                this.isUninitialized() || this.getType() == BasicValue.REFERENCE_VALUE);
    }
}
